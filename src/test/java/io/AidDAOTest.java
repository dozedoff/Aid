...
public class AidDAOTest extends DatabaseTestCase {
	...
	public void testAddFilter() throws Exception {
		...
		Assertion.assertEqualsIgnoreCols(getFileTable(enumToString(Filter), addExpected_PATH), getDatabaseTable(enumToString(Filter)),
				IGNORE_CACHE_COL);
	}
	...
	public void testUpdateState() throws Exception {
		...
		Assertion.assertEqualsIgnoreCols(getFileTable(enumToString(Filter), updateStateExpected_PATH),
				getDatabaseTable(enumToString(Filter)), IGNORE_CACHE_COL);
	}
	...
	public void testDelete() throws Exception {
		...
		Assertion.assertEqualsIgnoreCols(getFileTable(enumToString(Filter), deleteExpected_PATH), getDatabaseTable(enumToString(Filter)),
				IGNORE_CACHE_COL);
	...
	public void testTriggerThumbsUpdate() throws Exception {
		...
		Assertion.assertEqualsIgnoreCols(getFileTable("thumbs", triggerExpected_PATH), getDatabaseTable("thumbs"),
				IGNORE_THUMBS_TRIGGER_COL);
	}
	...
	public void testAddIndex() throws Exception {
		...
		Assertion.assertEqualsIgnoreCols(getFileTable(enumToString(Fileindex), addExpected_PATH),
				getDatabaseTable(enumToString(Fileindex)), IGNORE_ADD_HASH_COL);
		Assertion.assertEqualsIgnoreCols(getFileTable(enumToString(Dirlist), addExpected_PATH), getDatabaseTable(enumToString(Dirlist)),
				IGNORE_PATH_COL);
		Assertion.assertEqualsIgnoreCols(getFileTable(enumToString(Filelist), addExpected_PATH), getDatabaseTable(enumToString(Filelist)),
				IGNORE_PATH_COL);
	}
	...
	public void testAddDuplicate() throws Exception {
		...
		Assertion.assertEqualsIgnoreCols(getFileTable(enumToString(Fileduplicate), addExpected_PATH),
				getDatabaseTable(enumToString(Fileduplicate)), IGNORE_ADD_HASH_COL);
		Assertion.assertEqualsIgnoreCols(getFileTable(enumToString(Dirlist), addExpected_PATH), getDatabaseTable(enumToString(Dirlist)),
				IGNORE_PATH_COL);
		Assertion.assertEqualsIgnoreCols(getFileTable(enumToString(Filelist), addExpected_PATH), getDatabaseTable(enumToString(Filelist)),
				IGNORE_PATH_COL);
	...
	public void testDeleteByPathString() throws Exception {
		...
		Assertion.assertEquals(getFileTable(enumToString(Fileduplicate), deleteExpected_PATH),
				getDatabaseTable(enumToString(Fileduplicate)));
	}
